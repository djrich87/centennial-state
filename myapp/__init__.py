...
app.config['SQLALCHEMY_DATABASE_URI'] = "postgresql://localhost:5432/centennialstate"
...
from myapp.ski_slope_posts.views import ski_slope_posts
app.register_blueprint(ski_slope_posts)